...
import { Headset, ArrowLeft, Shield } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#0E1528] text-white flex flex-col justify-center items-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-1/4 w-96 h-96 bg-sky-600/20 rounded-full blur-3xl pointer-events-none -z-10"
      />
      <motion.div
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
      ...
      <div className="w-full max-w-lg relative z-10 my-8">
        ...
        >
          <Link
            href="/"
            className="group flex flex-col items-center justify-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 rounded-3xl p-2 transition-transform"
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-slate-300 group-hover:text-sky-300 transition-colors">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-[11px] font-extrabold uppercase tracking-wider text-sky-400 bg-sky-500/15 border border-sky-400/30 px-3 py-1 rounded-full">
              Dispatcher
            </span>
          </div>

          <div className="mb-6">
            <div className="w-12 h-12 rounded-2xl bg-sky-600/20 border border-sky-400/30 text-sky-300 flex items-center justify-center mb-4 shadow-md">
            ...
            <p className="text-slate-300 text-sm mt-1.5 leading-relaxed">
              Join an existing company workspace or operate independently to find available trucks.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  placeholder="Jane"
                  className="w-full px-4 py-3 rounded-xl border border-white/15 bg-[#0E1528]/90 text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-sky-400 text-sm"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-slate-300 mb-1.5">
            ...
            <div>
              ...
              <select className="w-full px-4 py-3 rounded-xl border border-white/15 bg-[#0E1528] text-white focus:outline-none focus:ring-2 focus:ring-sky-400 text-sm">
                <option>Independent Freelance Dispatcher</option>
                <option>Joining an Agency via Invite Code</option>
                <option>In-house Carrier Dispatcher</option>
              </select>
            </div>
            ...
            <div className="flex items-center justify-center gap-2 text-xs text-slate-400 pt-3 border-t border-white/10">
              ...
              <span>Direct access to verified carrier fleets</span>
            </div>
          </div>
        </motion.div>
      </div>
